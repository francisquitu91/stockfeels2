...
try:
    # websockets<11 exposed asyncio-specific subpackages
    from websockets.asyncio.client import ClientConnection
except Exception:
    try:
        # websockets>=11 exposes WebSocketClientProtocol in websockets.client
        from websockets.client import WebSocketClientProtocol as ClientConnection
    except Exception:
        # Fallback to a generic type to avoid hard failure; runtime will still fail if incompatible
